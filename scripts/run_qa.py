...
if os.environ.get("GOOGLE_APPLICATION_CREDENTIALS", "").startswith("/path/to/") or (os.environ.get("GOOGLE_APPLICATION_CREDENTIALS") and not os.path.exists(os.environ.get("GOOGLE_APPLICATION_CREDENTIALS", ""))):
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Query the NVIDIA Blog RAG system"
    )
    parser.add_argument(
        "question",
        nargs="?",
